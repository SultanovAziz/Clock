    ...
    <div class="container">
        <div class="single-main">
            <?php $currency = \clock\App::$app->getProperty('currency');
                  $cats = \clock\App::$app->getProperty('cats');?>
            <div class="col-md-9 single-main-left">
                <div class="sngl-top">
                    ...
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <h5 class="item_price" id="data-base" data-base="<?=$product->price*$currency['value'] ?>"><?= $currency['symbol_left'].$product->price*$currency['value'].$currency['symbol_right']; ?></h5>
                            <p><?= $product->content; ?></p>
                            <div class="available">
                                <ul>
                                    <li>Color
                                ...
                                <div class="col-md-4 product-left p-left">
                                    <div class="product-main simpleCart_shelfItem">
                                        ...
                                        <div class="product-bottom">
                                            <h3><a href="procut/<?=$item['alias'];?>"></a><?= $item['title']; ?></h3>
                                            <p>Explore Now</p>
                                            <h4><a class="item_add add-to-cart-link" href="cart/add?id=<?=$item['id']; ?>"><i></i></a> <span class=" item_price"><?= $currency['symbol_left'].$item['price']*$currency['value'].$currency['symbol_right'];?></span>
                                        ...
                                        <?php if($item['old_price']): ?>
                                            <div class="srch">
                                                <span><?= "A discond : "  .round((($item['old_price']-$item['price'])/$item['old_price'])*100) ?> %</span>
                                            </div>
                                        <?php endif;  ?>
                                    </div>
                                </div>
                ...
                <?php if(!empty($recentlyViewed)): ?>
                    <div class="latestproducts">
                        <div class="product-one">
                            <h3>Не давно просмотренные товары: </h3>
