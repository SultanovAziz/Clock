                        ...
                        <div class="col-md-4 product-left p-left">
                            <div class="product-main simpleCart_shelfItem">
                                ...
                                <div class="product-bottom">
                                    ...
                                    <p>Explore Now</p>
                                    <h4><a class="item_add" data-id="<?=$product->id;?>" href="cart/add?id<?=$product->id;?>"><i></i></a> <span class=" item_price">$ 329</span>
                                ...
                                <div class="srch srch1">
                                    <?php if($product->old_price): ?>
                                       <span><?=round(($product->old_price-$product->price)) ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
